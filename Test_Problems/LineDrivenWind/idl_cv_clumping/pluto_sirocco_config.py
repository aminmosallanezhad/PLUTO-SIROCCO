...
data = {
    ...
    "nproc_cak": 60,           # Number of cores for CAK code
    "nproc_pluto": 60,         # Number of cores for Pluto code
    "nproc_radhydro": 40,      # Number of cores for rad_hydro_files code

    # Radial grid parameters
    "R_MIN": 1.0,              # Radial grid minimum (units depend on context)
    "R_MAX": 10.,              # Radial grid maximum
    ...
    "R_0": 8.7e8,               # Density scaling radius in cm
